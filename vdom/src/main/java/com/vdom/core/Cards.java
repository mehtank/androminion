...
public class Cards {
    ...
    static {
        ...
        actionCardsPromo.add(prince        = new CardImpl.Builder(Cards.Kind.Prince, 8, Type.Action, Type.Duration).description("You may set aside (on this) a non-Duration Action card from your hand costing up to (4) Coins. At the start of each of your turns, play that card, leaving it set aside.").expansion(Expansion.Promo).build());
