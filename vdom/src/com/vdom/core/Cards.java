...
public class Cards {
    ...
    static {
        ...
        actionCardsAdventures.add(bridgeTroll     = new ActionDurationCardImpl.Builder(Cards.Type.BridgeTroll, 5).addBuysNextTurn(1).addBuys(1).attack().description("Each other player takes his -1 Coin token. ~ While this is on play, cards cost 1 Coin less on your turns, but not less than 0 Coins.").expansion("Adventures").build());
