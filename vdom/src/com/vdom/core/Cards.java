...
public class Cards {
    ...
    static {
        ...
        virtualCatapultRocks = new CardImpl.Builder(Cards.Kind.VirtualCatapultRocks, 3, Type.Action, Type.Attack).description("This pile starts the game with 5 copies of Catapult on top, then 5 copies of Rocks. Only the top card of the pile can be gained or bought.").expansion(Expansion.Empires).build();
        ...
        virtualEncampmentPlunder = new CardImpl.Builder(Cards.Kind.VirtualEncampmentPlunder, 2, Type.Action).description("This pile starts the game with 5 copies of Encampment on top, then 5 copies of Plunder. Only the top card of the pile can be gained or bought.").expansion(Expansion.Empires).build();
        ...
        virtualGladiatorFortune = new CardImpl.Builder(Cards.Kind.VirtualGladiatorFortune, 3, Type.Action).description("This pile starts the game with 5 copies of Gladiator on top, then 5 copies of Fortune. Only the top card of the pile can be gained or bought.").expansion(Expansion.Empires).build();
        ...
        virtualPatricianEmporium = new CardImpl.Builder(Cards.Kind.VirtualPatricianEmporium, 2, Type.Action).description("This pile starts the game with 5 copies of Patrician on top, then 5 copies of Emporium. Only the top card of the pile can be gained or bought.").expansion(Expansion.Empires).build();
        ...
        virtualSettlersBustlingVillage = new CardImpl.Builder(Cards.Kind.VirtualSettlersBustlingVillage, 2, Type.Action).description("This pile starts the game with 5 copies of Settlers on top, then 5 copies of Bustling Village. Only the top card of the pile can be gained or bought.").expansion(Expansion.Empires).build();
        ...
        virtualCastle   = new CardImpl.Builder(Cards.Kind.VirtualCastle, 3, Type.Victory, Type.Castle).description("Sort the Castle pile by cost, putting the more expensive Castles on the bottom. For a 2-player game, use only one of each Castle. Only the top card of the pile can be gained or bought.").build();
