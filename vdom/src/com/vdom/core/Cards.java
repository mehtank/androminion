...
public class Cards {
    ...
    static {
        ...
        landmarkCardsEmpires.add(tomb          = new CardImpl.Builder(Cards.Kind.Tomb, Type.Landmark).description("When you trash a card, +1 Victory token.").expansion(Expansion.Empires).build());
