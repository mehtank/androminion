...
public class Cards {
    ...
    static {
        ...
        actionCardsSeaside.add(embargo = new CardImpl.Builder(Cards.Kind.Embargo, 2, Type.Action).addGold(2).description("Trash this. If you did, add an Embargo token to a Supply pile. (For the rest of the game, when a player buys a card from that pile, they gain a Curse.)").expansion(Expansion.Seaside).build());
