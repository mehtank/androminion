...
public class Cards {
    ...
    static {
        ...
        actionCardsEmpires.add(sacrifice       = new CardImpl.Builder(Cards.Kind.Sacrifice, 4, Type.Action).description("Trash a card from your hand. If it's an... Action card, +2 Cards, +2 Actions; Treasure card, +(2) Coins; Victory card, +2 Victory tokens").expansion(Expansion.Empires).build());
