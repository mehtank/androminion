...
public class Cards {
    ...
    static {
        ...
        actionCardsSeaside.add(embargo = new CardImpl.Builder(Cards.Kind.Embargo, 2, Type.Action).addGold(2).description("Trash this card. Put an Embargo token on top of a Supply pile. When a player buys a card, he gains a Curse card per Embargo token on that pile.").expansion(Expansion.Seaside).build());
        ...
        actionCardsDarkAges.add(pillage = new CardImpl.Builder(Cards.Kind.Pillage, 5, Type.Action, Type.Attack).description("Trash this. Each other player with 5 or more cards in hand reveals his hand and discards a card that you choose. Gain 2 Spoils from the Spoils pile.").expansion(Expansion.DarkAges).build());
        ...
        actionCardsGuilds.add(merchantGuild    = new CardImpl.Builder(Cards.Kind.MerchantGuild, 5, Type.Action).addBuys(1).addGold(1).description("While this is in play, when you buy a card, +1 Coffers.").expansion(Expansion.Guilds).build());
        ...
        castleCards.add(opulentCastle       = new CardImpl.Builder(Cards.Kind.OpulentCastle, 7, Type.Action, Type.Victory, Type.Castle).hasPlusCoin().vp(3).description("Discard any number of Victory cards. +(2) Coins per card discarded.").expansion(Expansion.Empires).build());
        ...
        actionCardsEmpires.add(charm                          = new CardImpl.Builder(Cards.Kind.Charm, 5, Type.Treasure).hasPlusCoin().description("When you play this, choose one: +1 Buy and +(2) Coins; or the next time you buy a card this turn, you may also gain a differently named card with the same cost.").expansion(Expansion.Empires).build());
        ...
        actionCardsEmpires.add(farmersMarket                  = new CardImpl.Builder(Cards.Kind.FarmersMarket, 3, Type.Action, Type.Gathering).hasPlusCoin().addBuys(1).description("If there are 4 Victory tokens or more on the Farmers' Market Supply pile, take them and trash this. Otherwise, add 1 Victory token to the pile and then +(1) Coin per 1 Victory token on the pile.").expansion(Expansion.Empires).build());
        ...
        actionCardsEmpires.add(sacrifice                      = new CardImpl.Builder(Cards.Kind.Sacrifice, 4, Type.Action).hasPlusCoin().trashForced().description("Trash a card from your hand. If it's an... Action card, +2 Cards, +2 Actions; Treasure card, +(2) Coins; Victory card, +2 Victory tokens").expansion(Expansion.Empires).build());
        ...
        nonSupplyCards.add(goat           = new CardImpl.Builder(Cards.Kind.Goat, 2, Type.Treasure, Type.Heirloom).addGold(1).description("When you play this, you may trash a card from your hand.").expansion(Expansion.Nocturne).build());
        nonSupplyCards.add(luckyCoin      = new CardImpl.Builder(Cards.Kind.LuckyCoin, 4, Type.Treasure, Type.Heirloom).addGold(1).description("When you play this, gain a Silver.").expansion(Expansion.Nocturne).build());
        nonSupplyCards.add(magicLamp      = new CardImpl.Builder(Cards.Kind.MagicLamp, 0, Type.Treasure, Type.Heirloom).addGold(1).description("When you play this, if there are at least 6 cards that you have exactly 1 copy of in play, trash this. If you do, gain 3 Wishes from their pile.").expansion(Expansion.Nocturne).build());
        ...
        actionCardsNocturne.add(tormentor      = new CardImpl.Builder(Cards.Kind.Tormentor, 5, Type.Action, Type.Attack, Type.Doom).addGold(2).description("If you have no other cards in play, gain an Imp from its pile. Otherwise, each other player receives the next Hex.").expansion(Expansion.Nocturne).build());
        actionCardsNocturne.add(tracker        = new CardImpl.Builder(Cards.Kind.Tracker, 2, Type.Action, Type.Fate).addGold(1).heirloom(Cards.pouch).description("Receive a Boon. — While this is in play, when you gain a card, you may put that card onto your deck.").expansion(Expansion.Nocturne).build());
        ...
        artifactCardsRenaissance.add(lantern       = new CardImpl.Builder(Cards.Kind.Lantern, Type.Artifact).description("Your Border Guards reveal 3 cards and discard 2. (It takes all 3 being Actions to take the Horn.)").expansion(Expansion.Renaissance).build());
        ...
        actionCardsRenaissance.add(inventor        = new CardImpl.Builder(Cards.Kind.Inventor, 4, Type.Action).description("Gain a card costing up to (4) Coins, then cards cost (1) Coin less this turn (but not less than (0) Coins).").expansion(Expansion.Renaissance).build());
        ...
        actionCardsRenaissance.add(patron          = new CardImpl.Builder(Cards.Kind.Patron, 4, Type.Action, Type.Reaction).addVillagers(1).addGold(2).description("When something causes you to reveal this (using the word \"reveal\"), +1 Coffers.").expansion(Expansion.Renaissance).build());
        ...
        actionCardsRenaissance.add(scepter         = new CardImpl.Builder(Cards.Kind.Scepter, 5, Type.Treasure).hasPlusCoin().description("When you play this, choose one: +(2) Coins; or replay an Action card you played this turn that's still in play.").expansion(Expansion.Renaissance).build());
        ...
        projectCardsRenaissance.add(canal        = new CardImpl.Builder(Cards.Kind.Canal, 7, Type.Project).description("During your turns, cards cost (1) Coin less, but not less than (0) Coins.").expansion(Expansion.Renaissance).build());
    ...
    public static boolean isSupplyCard(Card c) {
        return !(nonSupplyCards.contains(c) || prizeCards.contains(c) || eventsCards.contains(c) || projectCards.contains(c) || landmarkCards.contains(c) || blackMarketCards.contains(c));
    }
