...
public class Cards {
    ...
    static {
        ...
        actionCardsBaseGame.add(library = new CardImpl.Builder(Cards.Kind.Library, 5, Type.Action).description("Draw until you have 7 cards in hand. You may set aside any Action cards drawn this way, as you draw them; discard the set aside cards after you finish drawing.").expansion(Expansion.Base).build());
        ...
        actionCardsIntrigue.add(miningVillage = new CardImpl.Builder(Cards.Kind.MiningVillage, 4, Type.Action).addCards(1).addActions(2).description("You may trash this card immediately. If you do, +2 Coins.").expansion(Expansion.Intrigue).build());
        ...
        // Ruins
        variablePileCards.add(abandonedMine     = new CardImpl.Builder(Cards.Kind.AbandonedMine, 0, Type.Action, Type.Ruins).addGold(1).expansion(Expansion.DarkAges).build());
        variablePileCards.add(ruinedLibrary     = new CardImpl.Builder(Cards.Kind.RuinedLibrary, 0, Type.Action, Type.Ruins).addCards(1).expansion(Expansion.DarkAges).build());
        variablePileCards.add(ruinedMarket      = new CardImpl.Builder(Cards.Kind.RuinedMarket, 0, Type.Action, Type.Ruins).addBuys(1).expansion(Expansion.DarkAges).build());
        variablePileCards.add(ruinedVillage     = new CardImpl.Builder(Cards.Kind.RuinedVillage, 0, Type.Action, Type.Ruins).addActions(1).expansion(Expansion.DarkAges).build());
        variablePileCards.add(survivors         = new CardImpl.Builder(Cards.Kind.Survivors, 0, Type.Action, Type.Ruins).description("Look at the top 2 cards of your deck. Discard them or put them back in any order.").expansion(Expansion.DarkAges).build());
        nonKingdomCards.add(virtualRuins = new CardImpl.Builder(Cards.Kind.VirtualRuins, 0, Type.Action, Type.Ruins).build());
        
        // Knights
        variablePileCards.add(dameAnna = new CardImpl.Builder(Cards.Kind.DameAnna, 5, Type.Action, Type.Attack, Type.Knight).description("You may trash up to 2 cards from your hand. " + KNIGHTS_TEXT).expansion(Expansion.DarkAges).build());
        variablePileCards.add(dameJosephine = new CardImpl.Builder(Cards.Kind.DameJosephine, 5, Type.Action, Type.Attack, Type.Victory, Type.Knight).vp(2).description(KNIGHTS_TEXT).expansion(Expansion.DarkAges).build());
        variablePileCards.add(dameMolly = new CardImpl.Builder(Cards.Kind.DameMolly, 5, Type.Action, Type.Attack, Type.Knight).addActions(2).description(KNIGHTS_TEXT).expansion(Expansion.DarkAges).build());
        variablePileCards.add(dameNatalie = new CardImpl.Builder(Cards.Kind.DameNatalie, 5, Type.Action, Type.Attack, Type.Knight).description("You may gain a card costing up to 3 coins. " + KNIGHTS_TEXT).expansion(Expansion.DarkAges).build());
        variablePileCards.add(dameSylvia = new CardImpl.Builder(Cards.Kind.DameSylvia, 5, Type.Action, Type.Attack, Type.Knight).addGold(2).description(KNIGHTS_TEXT).expansion(Expansion.DarkAges).build());
        variablePileCards.add(sirBailey = new CardImpl.Builder(Cards.Kind.SirBailey, 5, Type.Action, Type.Attack, Type.Knight).addActions(1).addCards(1).description(KNIGHTS_TEXT).expansion(Expansion.DarkAges).build());
        variablePileCards.add(sirDestry = new CardImpl.Builder(Cards.Kind.SirDestry, 5, Type.Action, Type.Attack, Type.Knight).addCards(2).description(KNIGHTS_TEXT).expansion(Expansion.DarkAges).build());
        variablePileCards.add(sirMartin = new CardImpl.Builder(Cards.Kind.SirMartin, 4, Type.Action, Type.Attack, Type.Knight).addBuys(2).description(KNIGHTS_TEXT).expansion(Expansion.DarkAges).build());
        variablePileCards.add(sirMichael = new CardImpl.Builder(Cards.Kind.SirMichael, 5, Type.Action, Type.Attack, Type.Knight).description("Each other player discards down to 3 cards in hand. " + KNIGHTS_TEXT).expansion(Expansion.DarkAges).build());
        variablePileCards.add(sirVander = new CardImpl.Builder(Cards.Kind.SirVander, 5, Type.Action, Type.Attack, Type.Knight).description(KNIGHTS_TEXT + " When you trash this, gain a Gold.").expansion(Expansion.DarkAges).build());
        ...
        actionCardsEmpires.add(virtualCastle                  = new CardImpl.Builder(Cards.Kind.Castles, 3, Type.Victory, Type.Castle).description("Sort the Castle pile by cost, putting the more expensive Castles on the bottom. For a 2-player game, use only one of each Castle. Only the top card of the pile can be gained or bought.").build());
        actionCardsEmpires.add(virtualCatapultRocks           = new CardImpl.Builder(Cards.Kind.CatapultRocks, 3, Type.Action, Type.Attack).description("This pile starts the game with 5 copies of Catapult on top, then 5 copies of Rocks. Only the top card of the pile can be gained or bought.").expansion(Expansion.Empires).build());
        ...
        actionCardsEmpires.add(virtualEncampmentPlunder       = new CardImpl.Builder(Cards.Kind.EncampmentPlunder, 2, Type.Action).description("This pile starts the game with 5 copies of Encampment on top, then 5 copies of Plunder. Only the top card of the pile can be gained or bought.").expansion(Expansion.Empires).build());
        ...
        actionCardsEmpires.add(virtualGladiatorFortune        = new CardImpl.Builder(Cards.Kind.GladiatorFortune, 3, Type.Action).description("This pile starts the game with 5 copies of Gladiator on top, then 5 copies of Fortune. Only the top card of the pile can be gained or bought.").expansion(Expansion.Empires).build());
        ...
        actionCardsEmpires.add(virtualPatricianEmporium       = new CardImpl.Builder(Cards.Kind.PatricianEmporium, 2, Type.Action).description("This pile starts the game with 5 copies of Patrician on top, then 5 copies of Emporium. Only the top card of the pile can be gained or bought.").expansion(Expansion.Empires).build());
        ...
        actionCardsEmpires.add(virtualSettlersBustlingVillage = new CardImpl.Builder(Cards.Kind.SettlersBustlingVillage, 2, Type.Action).description("This pile starts the game with 5 copies of Settlers on top, then 5 copies of Bustling Village. Only the top card of the pile can be gained or bought.").expansion(Expansion.Empires).build());
        ...
        variablePileCards.add(encampment          = new CardImpl.Builder(Cards.Kind.Encampment, 2, Type.Action).addActions(2).addGold(2).description("You may reveal a Gold or Plunder from your hand. If you do not, set this aside, and return it to the Supply at the start of Clean-up.").expansion(Expansion.Empires).build());
        ...
        // castles
        variablePileCards.add(humbleCastle        = new CardImpl.Builder(Cards.Kind.HumbleCastle, 3, Type.Treasure, Type.Victory, Type.Castle).addGold(1).description("Worth 1 VP per Castle you have.").expansion(Expansion.Empires).build());
        variablePileCards.add(crumblingCastle     = new CardImpl.Builder(Cards.Kind.CrumblingCastle, 3, Type.Victory, Type.Castle).vp(1).description("When you gain or trash this, +1 Victory token and gain a Silver.").expansion(Expansion.Empires).build());
        variablePileCards.add(smallCastle         = new CardImpl.Builder(Cards.Kind.SmallCastle, 5, Type.Action, Type.Victory, Type.Castle).vp(2).trashForced().description("Trash this or a Castle from your hand. If you do, gain a Castle.").expansion(Expansion.Empires).build());
        variablePileCards.add(hauntedCastle       = new CardImpl.Builder(Cards.Kind.HauntedCastle, 6, Type.Victory, Type.Castle).vp(2).description("When you gain this during your turn, gain a Gold, and each other player with 5 or more cards in hand puts 2 cards from their hand onto their deck.").expansion(Expansion.Empires).build());
        variablePileCards.add(opulentCastle       = new CardImpl.Builder(Cards.Kind.OpulentCastle, 7, Type.Action, Type.Victory, Type.Castle).vp(3).description("Discard any number of Victory cards. +(2) Coins per card discarded.").expansion(Expansion.Empires).build());
        variablePileCards.add(sprawlingCastle     = new CardImpl.Builder(Cards.Kind.SprawlingCastle, 8, Type.Victory, Type.Castle).vp(4).description("When you gain this, gain a Duchy or 3 Estates.").expansion(Expansion.Empires).build());
        variablePileCards.add(grandCastle         = new CardImpl.Builder(Cards.Kind.GrandCastle, 9, Type.Victory, Type.Castle).vp(5).description("When you gain this, reveal your hand. +1 Victory token per Victory card in your hand and/or in play.").expansion(Expansion.Empires).build());
        variablePileCards.add(kingsCastle         = new CardImpl.Builder(Cards.Kind.KingsCastle, 10, Type.Victory, Type.Castle).description("Worth 2 VP per Castle you have.").expansion(Expansion.Empires).build());
