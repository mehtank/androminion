...
public class CardSet {
    ...
    /*frr18 AdventureTest*/
		CardSetMap.put(GameType.AdventureTest, new CardSet(new Card[]{Cards.enchantress, Cards.urchin, Cards.chapel, Cards.villa, Cards.youngWitch, Cards.battlefield}, null));
