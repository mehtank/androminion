...
public class CardSet {
    ...
    /*frr18 AdventureTest*/
		...
		CardSetMap.put(GameType.EmpiresTest, new CardSet(new Card[] { Cards.donate, Cards.chapel, Cards.pathfinding, Cards.huntingGrounds, Cards.bandOfMisfits, Cards.virtualCastle, Cards.virtualCatapultRocks, Cards.virtualEncampmentPlunder, Cards.virtualGladiatorFortune, Cards.virtualKnight, Cards.virtualPatricianEmporium, Cards.virtualSettlersBustlingVillage, Cards.overlord, Cards.cultist, Cards.page, Cards.duplicate, Cards.messenger, Cards.artificer, Cards.disciple, Cards.transmogrify, Cards.pilgrimage, Cards.engineer, Cards.taxman, Cards.butcher, Cards.stonemason, Cards.rebuild, Cards.highway, Cards.graverobber, Cards.squire, Cards.catacombs, Cards.forge, Cards.ambassador, Cards.develop}, null));
		CardSetMap.put(GameType.BasicIntro, new CardSet(new Card[] { Cards.virtualCastle, Cards.chariotRace, Cards.cityQuarter, Cards.engineer, Cards.farmersMarket, Cards.forum, Cards.legionary, Cards.virtualPatricianEmporium, Cards.sacrifice, Cards.villa, Cards.wedding, Cards.tower}, null));
