...
public class CardSet {
    ...
    /*frr18 AdventureTest*/
		CardSetMap.put(GameType.AdventureTest, new CardSet(new Card[]{Cards.enchantress, Cards.urchin, Cards.temple, Cards.villa, Cards.youngWitch, Cards.battlefield, Cards.keep}, null));
