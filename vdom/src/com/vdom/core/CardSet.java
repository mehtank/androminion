...
public class CardSet {
    ...
    /*frr18 AdventureTest*/
		CardSetMap.put(GameType.AdventureTest, new CardSet(new Card[]{Cards.virtualPatricianEmporium, Cards.virtualCastle, Cards.virtualCatapultRocks, Cards.virtualEncampmentPlunder, Cards.virtualGladiatorFortune, Cards.virtualKnight, Cards.virtualSettlersBustlingVillage, Cards.marauder}, null));
