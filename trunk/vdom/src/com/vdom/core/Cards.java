...
public class Cards {
    ...
    static {
        ...
        actionCardsSeaside.add(tactician = new ActionDurationCardImpl.Builder(Cards.Type.Tactician, 5).addCardsNextTurn(5).addBuysNextTurn(1).addActionsNextTurn(1).description("Discard your hand. If you discarded any cards this way, then at the start of your next turn, +5 Cards, +1 Buy, and +1 Action.").expansion("Seaside").build());
