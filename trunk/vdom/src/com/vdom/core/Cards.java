...
public class Cards {
    ...
    static {
        ...
        actionCardsSeaside.add(island = new ActionVictoryCardImpl.Builder("Island", 4).trashOnUse().vp(2).description("Set aside this and another card from your hand. Return them to your deck at the end of the game.").expansion("Seaside").build());
        ...
        actionCardsSeaside.add(outpost = new ActionDurationCardImpl.Builder("Outpost", 5).takeAnotherTurn(true).description("You only draw 3 cards (instead of 5) in this turn's Clean-up phase. Take an extra turn after this one. This can't cause you to take more than two consecutive turns.").expansion("Seaside").build());
        ...
        actionCardsSeaside.add(tactician = new ActionDurationCardImpl.Builder("Tactician", 5).addCardsNextTurn(5).addBuysNextTurn(1).addActionsNextTurn(1).trashOnUse().description("Discard your hand. If you discarded any cards this way, then at the start of your next turn, +5 Cards, +1 Buy, and +1 Action.").expansion("Seaside").build());
        actionCardsSeaside.add(treasureMap = new ActionCardImpl.Builder("Treasure Map", 4).trashOnUse().description("Trash this and another copy of Treasure Map from your hand. If you do trash two Treasure Maps, gain 4 Gold cards putting them on top of your deck.").expansion("Seaside").build());
        ...
        actionCardsProsperity.add(contraband = new TreasureCardImpl.Builder("Contraband", 5, 3).description("When you play his, the player to your left names a card.  You can't buy that card this turn.").expansion("Prosperity").build());
		...
		// Hinterlands
        actionCardsHinterlands.add(bagOfGold = new ActionCardImpl.Builder("Bag of Gold", 0).addActions(1).isPrize().description("Gain a Gold, putting it on top of your deck.  (This is not in the Supply.)").expansion("Hinterlands").build());
        ...
        actionCardsHinterlands.add(diadem = new TreasureCardImpl.Builder("Diadem", 0, 2).isPrize().description("When you play this, +1 coin per unused Action you have (Action, not Action card).  (This is not in the Supply.)").expansion("Hinterlands").build());
        ...
        actionCardsHinterlands.add(followers = new ActionCardImpl.Builder("Followers", 0).addCards(2).attack().isPrize().description("Gain an Estate.  Each other player gains a Curse and discards down to 3 cards in hand.  (This is not in the Supply.)").expansion("Hinterlands").build());
        ...
        actionCardsHinterlands.add(princess = new ActionCardImpl.Builder("Princess", 0).addBuys(1).isPrize().description("While this is in play, cards cost 2 coins less, but not less than 0.  (This is not in the Supply.)").expansion("Hinterlands").build());
        ...
        actionCardsHinterlands.add(trustySteed = new ActionCardImpl.Builder("Trusty Steed", 0).isPrize().description("Choose two:  +2 Cards; +2 Actions; +2 coins; gain 4 silvers and put your deck into your discard pile.  (The choices must be different.)  (This is not in the Supply.)").expansion("Hinterlands").build());
