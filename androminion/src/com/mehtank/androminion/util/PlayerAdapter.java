...
public class PlayerAdapter extends ArrayAdapter<PlayerSummary> {
	...
	public View getView(int pos, View origView, ViewGroup parent) {
		...
		ps = getItem(pos);
		dv.set(ps.name, ps.turns, ps.deckSize, ps.handSize, ps.numCards, ps.pt, ps.vt, ps.gct, ps.minusOneCoinTokenOn, ps.minusOneCardTokenOn, ps.journeyTokenFaceUp, ps.highlight, ps.showColor, ps.color);
		return dv;
	}
