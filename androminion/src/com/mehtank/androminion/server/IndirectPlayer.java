...
//			sco.isPassable();
    ...
    public Card getFromTable(MoveContext context, String header, int maxCost, int minCost, boolean isBuy, String passString, boolean actionOnly, boolean victoryAllowed) {
        return getFromTable(context, header, maxCost, minCost, isBuy, passString, actionOnly, victoryAllowed, -1);
    }

    public Card getFromTable(MoveContext context, String header, int maxCost, int minCost, boolean isBuy, String passString, boolean actionOnly, boolean victoryAllowed, int potionCost) {
        return getFromTable(context, header, maxCost, minCost, isBuy, passString, actionOnly, victoryAllowed, potionCost, false);
    }
...
//			sco.isPassable();
	...
	public Card doAction(MoveContext context) {
        ...
        Card[] cards = getFromHand(context, getString(R.string.part_play), getString(R.string.none), ACTIONFROMHAND, 1, false, false, SelectCardOptions.PickType.PLAY);
        if (cards == null)
            return null;
	...
	public Card[] actionCardsToPlayInOrder(MoveContext context) {
        ...
        Card[] cards = getFromHand(context, getString(R.string.part_play), getString(R.string.none), ACTIONFROMHAND, actionCount, false, true, SelectCardOptions.PickType.PLAY_IN_ORDER);
        if (cards == null) {
            return null;
        }
	...
	public Card workshop_cardToObtain(MoveContext context) {
        ...
        return getFromTable(context, getGainString(Cards.workshop), 4, Integer.MIN_VALUE, false, NOTPASSABLE, false, true, 0);
    }
	...
	public Card feast_cardToObtain(MoveContext context) {
        ...
        return getFromTable(context, getGainString(Cards.feast), 5, Integer.MIN_VALUE, false, NOTPASSABLE, false, true, 0);
    }
    ...
    public Card remodel_cardToObtain(MoveContext context, int maxCost, boolean potion) {
        ...
        return getFromTable(context, getGainString(Cards.remodel), maxCost, Integer.MIN_VALUE, false, NOTPASSABLE, false, true, potion ? 1 : 0);
    }
    ...
    public Card swindler_cardToSwitch(MoveContext context, int cost, boolean potion) {
        ...
        return getFromTable(context, Strings.format(R.string.swindler_part, "" + cost), cost, cost, false, NOTPASSABLE, false, true, potion ? 1 : 0);
	}
    ...
    public Card ironworks_cardToObtain(MoveContext context) {
        ...
        return getFromTable(context, getCardName(Cards.ironworks), 4, Integer.MIN_VALUE, false, NOTPASSABLE, false, true, 0);
	}
    ...
    public Card saboteur_cardToObtain(MoveContext context, int maxCost, boolean potion) {
        ...
        return getFromTable(context, getString(R.string.saboteur_part), maxCost, Integer.MIN_VALUE, false, getString(R.string.none), false, true, potion ? 1 : 0);
	}
    ...
    public Card upgrade_cardToObtain(MoveContext context, int exactCost, boolean potion) {
        ...
        return getFromTable(context, getGainString(Cards.upgrade), exactCost, exactCost, false, NOTPASSABLE, false, true, potion ? 1 : 0);
	}
...
//        }
    ...
    public ActionCard university_actionCardToObtain(MoveContext context) {
        ...
        return (ActionCard) getFromTable(context, getString(R.string.university_part), 5, Integer.MIN_VALUE, false, getString(R.string.none), true, true, 0);
    }
    ...
    public Card expand_cardToObtain(MoveContext context, int maxCost, boolean potion) {
        ...
        return getFromTable(context, getGainString(Cards.expand), maxCost, Integer.MIN_VALUE, false, NOTPASSABLE, false, true, potion ? 1 : 0);
    }
    ...
    public Card forge_cardToObtain(MoveContext context, int exactCost) {
        ...
        return getFromTable(context, getGainString(Cards.forge), exactCost, exactCost, false, NOTPASSABLE, false, true, 0);
    }
    ...
    public Card hornOfPlenty_cardToObtain(MoveContext context, int maxCost) {
        ...
        return getFromTable(context, getGainString(Cards.hornOfPlenty), maxCost, Integer.MIN_VALUE, false, NOTPASSABLE, false, true, 0);
    }
    ...
    public Card remake_cardToObtain(MoveContext context, int exactCost, boolean potion) {
        ...
        return getFromTable(context, getGainString(Cards.remake), exactCost, exactCost, false, NOTPASSABLE, false, true, potion ? 1 : 0);
    }
    ...
    public Card develop_lowCardToGain(MoveContext context, int cost, boolean potion) {
        ...
        return getFromTable(context, getGainString(Cards.develop), cost, cost, false, NOTPASSABLE, false, true, potion ? 1 : 0);
    }
    ...
    public Card borderVillage_cardToObtain(MoveContext context) {
        ...
        return getFromTable(context, getGainString(Cards.borderVillage), Cards.borderVillage.getCost(context) - 1, Integer.MIN_VALUE, false, NOTPASSABLE, false, true, 0);
    }
    ...
    public Card farmland_cardToObtain(MoveContext context, int exactCost, boolean potion) {
        ...
        return getFromTable(context, getGainString(Cards.farmland), exactCost, exactCost, false, NOTPASSABLE, false, true, potion ? 1 : 0);
    }
