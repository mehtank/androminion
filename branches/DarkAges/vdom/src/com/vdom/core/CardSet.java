...
public class CardSet {
	...
	static {
		...
		CardSetMap.put(GameType.DarkAgesTest, new CardSet(new Card[]{Cards.banditCamp, Cards.counterfeit, Cards.marketSquare, Cards.scavenger, Cards.forager, Cards.pillage, Cards.sage, Cards.rats, Cards.rebuild, Cards.mystic}, null));
