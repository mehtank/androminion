...
public class CardSet {
	...
	static {
		...
		CardSetMap.put(GameType.DarkAgesTest, new CardSet(new Card[]{Cards.banditCamp, Cards.counterfeit, Cards.marketSquare, Cards.catacombs, Cards.forager, Cards.pillage, Cards.rats, Cards.huntingGrounds, Cards.rebuild, Cards.squire}, null));
