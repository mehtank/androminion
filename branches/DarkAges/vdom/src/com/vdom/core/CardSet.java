...
public class CardSet {
	...
	static {
		...
		CardSetMap.put(GameType.DarkAgesTest, new CardSet(new Card[]{Cards.envoy, Cards.governor, Cards.marketSquare, Cards.scavenger, Cards.forager, Cards.pillage, Cards.sage, Cards.rats, Cards.walledVillage, Cards.procession}, null));
