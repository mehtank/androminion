...
public class CardSet {
	...
	static {
		...
		CardSetMap.put(GameType.DarkAgesTest, new CardSet(new Card[]{Cards.forager, Cards.virtualKnight, Cards.marketSquare, Cards.counterfeit, Cards.procession, Cards.pillage, Cards.hermit, Cards.urchin, Cards.deathCart, Cards.tournament}, null));
